...
- Unfortunately, the buttons for 'easy', 'hard', 'medium' do not work in the final release. They were working the day before, but someone deleted the event handlers for these buttons and compiled them into one without testing to see if his changes worked. 
